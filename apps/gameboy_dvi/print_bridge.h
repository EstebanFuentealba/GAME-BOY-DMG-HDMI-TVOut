...
#define PRINT_HEADER_SOURCE_WIDTH 384
#define PRINT_HEADER_SOURCE_HEIGHT 139
#define PRINT_HEADER_HEIGHT_DOTS ((PRINT_HEADER_SOURCE_HEIGHT * PRINT_WIDTH_DOTS + (PRINT_HEADER_SOURCE_WIDTH / 2)) / PRINT_HEADER_SOURCE_WIDTH)
